...
const Menu = ({handleOpenMenu, openMenu}) => {
  return (
    <div className={`h-[250px] border z-50 grid font-bold text-xl bg-gray-800/90 p-5 transition-all duration-500 ${openMenu ? "fixed right-2 top-2" : "fixed right-4 -top-72"}`}>
