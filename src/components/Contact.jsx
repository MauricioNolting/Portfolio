  ...
  return (
    <div className="h-auto my-10 w-screen">
      <div className="justify-start items-start flex sm:pl-10 my-5">
        ...
        <img
          className="relative top-6 w-[150px] sm:w-auto sm:border-none border-2 border-purple-400"
          src="/Line.png"
          alt=""
        />
      </div>
      ...
      <section className="h-auto sm:grid sm:grid-cols-2 sm:grid-rows-[auto,1fr] mx-5 flex-auto sm:gap-2 gap-3 w-full">
        ...
        <div className="grid sm:h-[160px] sm:w-[300px] w-[300px]  h-[100px] col-start-2 row-start-2 border rounded-sm mt-7 mx-auto">
          ...
          <a
            className="flex my-auto px-2 mx-auto hover:text-purple-400 hover:font-semibold"
            href="mailto:mauricionolting@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
            <i className="bx bxl-gmail mx-3 my-auto"></i>
            mauricionolting@gmail.com
          </a>

          <button
            onClick={copyNumber}
            id="pohneNumber"
            className="hover:text-purple-400 transition-all hover:font-semibold hover:text-lg line-clamp-1 my-auto px-2 mx-auto"
          >
            <i className="bx bxs-phone mx-3 my-auto"></i>+54 1162677362
          </button>
